...
export function Component() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      // AuthContext will handle redirection via App component
    } catch (err: any) {
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <motion.div className="space-y-3">
                    ...
                    >
                      ...
                      <div className="relative flex items-center overflow-hidden rounded-lg px-3">
                        <Mail className={`mr-3 w-4 h-4 transition-all duration-300 pointer-events-none ${
                        ...
                        <Input
                          ...
                          className="flex-1 bg-white/5 border-transparent focus:border-white/20 text-white placeholder:text-white/30 h-10 transition-all duration-300 pr-3 focus:bg-white/10"
                        />
                    ...
                    >
                      ...
                      <div className="relative flex items-center overflow-hidden rounded-lg px-3">
                        <Lock className={`mr-3 w-4 h-4 transition-all duration-300 pointer-events-none ${
                        ...
                        <Input
                          ...
                          onBlur={() => setFocusedInput(null)}
                          className="flex-1 bg-white/5 border-transparent focus:border-white/20 text-white placeholder:text-white/30 h-10 transition-all duration-300 pr-10 focus:bg-white/10"
                        />
                  ...
                  <div className="flex items-center justify-between pt-1">
                    ...
                    <div className="text-xs relative group/link">
                      <a href="/forgot-password" className="text-white/60 hover:text-white transition-colors duration-200">
                        Forgot password?
                      </a>
                    </div>
                  </div>
