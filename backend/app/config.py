...
class AppSettings(BaseSettings):
    ...
    log_format: str = Field(default_factory=lambda: os.getenv("LOG_FORMAT", "console").lower(), description="Log format (json or console)")
    ...
    session_timeout: int = Field(default_factory=lambda: int(os.getenv("SESSION_TIMEOUT", "300")), description="Session timeout in seconds")
